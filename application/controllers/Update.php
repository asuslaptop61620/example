...
class Update extends CI_Controller
{
    ...
    public function v5_1to5_1_2()
    {
      $lines="INSERT INTO `menu` ( `name`, `icon`, `url`, `serial`, `module_access`, `have_child`, `only_admin`, `only_member`, `add_ons_id`, `is_external`) VALUES ('Cron Job', 'fa fa-clock-o', 'cron_job/index', '23', '15', '0', '1', '0', '0', '0')";
        ...
        echo "SiteSpy has been updated to v5.1.2 successfully.".$count." queries executed.";
    }

    public function v4_3to5_0()
    {
        $lines="INSERT INTO `menu_child_2` (`id`, `name`, `url`, `serial`, `icon`, `module_access`, `parent_child`, `only_admin`, `only_member`, `is_external`) VALUES (NULL, 'Frontend Settings', 'admin_config/frontend_configuration', '1', 'fa fa-newspaper-o', '', '1', '1', '0', '0');
        ...
        UPDATE `menu` SET `name` = 'Bitly url shortener' WHERE `menu`.`id` = 18;
        ...
        echo "SiteSpy has been updated to v5.0 successfully.".$count." queries executed.";
    }
