 ...
 public function _language_loader()
                ...
                if ($smtp == '1') {
                    ...
                    if (count($email_config_details) == 0) {
                        ...
                        foreach ($email_config_details as $send_info) {
                            ...
                            $smtp_type = isset($send_info['smtp_type']) ? trim($send_info['smtp_type']) : 'Default';
                        }
    ...
    */
    ...
    public function code_activation_check_action($purchase_code,$only_domain){
         ...
         //$url = "https://mostofa.club/development/envato_license_activation/purchase_code_check.php?purchase_code={$purchase_code}&domain={$only_domain}&item_name=sitespy";
