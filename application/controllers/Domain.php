...
class Domain extends Home
{
    ...
    */
    ...
    public function domain_list_for_domain_details_data()
    {
        ...
        {        	
	        $query = "(user_id='0' or user_id='".$this->user_id."')";
	        $this->db->where($query);
        }
        else
    ...
    public function add_domain_action()
    {
        ...
        if(isset($fb_like_comment_share['total_comment_plugin']))
            $common_result['fb_total_comment_plugin'] = $fb_like_comment_share['total_comment_plugin'];
        else
            $common_result['fb_total_comment_plugin'] = 0;
    ...
    public function bulk_scan_progress_count()
    {
        ...
        if($insert_table_id != "")
        {
            ...
            $view_button = '<a href="'.$link.'" class="btn btn-outline-info"><i class="fa fa-eye"></i> '.$this->lang->line("detailed report").'</a><br/><br/>';
    ...
    public function ajax_get_social_network_data()
    {
        ...
        $domain_info['fb_total_comment_plugin'] = is_numeric($infos[0]['fb_total_comment_plugin']) ? number_format($infos[0]['fb_total_comment_plugin']) : $infos[0]['fb_total_comment_plugin'];
        ...
        $domain_info['social_network_pieChart'] = array(
            ...
            6 => array(
                'value' => $infos[0]['fb_total_like'],
                'color' => '#3b5998',
                'highlight' => '#3b5998',
                'label' => 'Facebook Reaction'
                ),
            7 => array(
                'value' => $infos[0]['fb_total_comment'],
                'color' => '#8ac9fe',
                'highlight' => '#8ac9fe',
                'label' => 'Facebook Comment'
                ),            
            8 => array(
                'value' => $infos[0]['fb_total_comment_plugin'],
                'color' => '#a5b6fa',
                'highlight' => '#a5b6fa',
                'label' => 'Facebook Comment Plugin'
                ),

            );
        $domain_info['color_codes'] = "
                                        <li><i class='fa fa-circle-o' style='color:#44B3C2'></i> Facebook Share </li>
                                        <li><i class='fa fa-circle-o' style='color:#3b5998'></i>Facebook Reaction </li>
                                        <li><i class='fa fa-circle-o' style='color:#8ac9fe'></i>Facebook Comment </li>
                                        <li><i class='fa fa-circle-o' style='color:#a5b6fa'></i>Facebook Comment Plugin </li>
