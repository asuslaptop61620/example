...
class Social extends Home
{
    ...
    public function social_action()
    {
      ...
      /* if(is_facebook==0 && is_linkedin==0 && is_googleplus==0 && is_xing==0 && is_reddit==0 && is_pinterest==0 && is_buffer==0 && is_stumbleupon==0);*/
        ...
        if($is_facebook==1) $str.="<td>Facebook Reaction</td>";
        if($is_facebook==1) $str.="<td>Facebook Comment</td>";
        if($is_facebook==1) $str.="<td>Facebook Comment Plugin</td>";
        ...
        if($is_facebook==1) $str.="<td>{$facebook_report['total_reaction']}</td>";
        if($is_facebook==1) $str.="<td>{$facebook_report['total_comment']}</td>";
        if($is_facebook==1) $str.="<td>{$facebook_report['total_comment_plugin']}</td>";
