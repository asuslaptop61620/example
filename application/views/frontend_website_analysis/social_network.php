...
<div role="tabpanel" class="tab-pane fade" id="social_network">
	...
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-sm-offset-3">
			<div class="box-header"><h3 class="text-center">Social Network Comparison</h3></div>
	...
	<div class="row" style="">
		...
		<div class="box-header"><h3 class="text-center">Reddit Information</h3></div>
		<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
			<div class="info-box">
				<span class="info-box-icon"><i class="fa fa-reddit blue2"></i></span>
		...
		<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
			<div class="info-box">
				<span class="info-box-icon"><i class="fa fa-reddit green"></i></span>
				<div class="info-box-content">
					<!-- <span class="info-box-text">Inventory</span> -->
		...
		<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
			<div class="info-box">
				<span class="info-box-icon"><i class="fa fa-reddit red"></i></span>
				<div class="info-box-content">
					<!-- <span class="info-box-text">Inventory</span> -->
