...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
			<div  class="info-box">
				<span class="info-box-icon"><i class="fa fa-tag blue2"></i></span>
	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 style="color: black; word-spacing: 5px;" class="box-title"><i class="fa fa-globe"></i> Traffic by Countries</h3>
		...
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 style="color: black; word-spacing: 5px;" class="box-title"><i class="fa fa-share-alt"></i> Social Media Traffic</h3>
					<div class="box-tools pull-right">
						<button data-widget="collapse" class="btn btn-box-tool"><i class="fa fa-minus"></i></button>
						<button data-widget="remove" class="btn btn-box-tool"><i class="fa fa-times"></i></button>
					</div>
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
			<div  class="info-box">
				<span class="info-box-icon"><i class="fa fa-arrow-down green"></i></span>
				<div class="info-box-content">
		...
		<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
			<div  class="info-box">
				<span class="info-box-icon"><i class="fa fa-share-alt blue2"></i></span>
				<div class="info-box-content">
		...
		<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
			<div  class="info-box">
				<span class="info-box-icon "><i class="fa fa-laptop orange"></i></span>
				<div class="info-box-content">
	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 style="color: black; word-spacing: 5px;" class="box-title"><i class="fa fa-arrow-down"></i> Top Referral Sites</h3>
					<div class="box-tools pull-right">
						<button data-widget="collapse" class="btn btn-box-tool"><i class="fa fa-minus"></i></button>
						<button data-widget="remove" class="btn btn-box-tool"><i class="fa fa-times"></i></button>
					</div>
		...
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">	
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 style="color: black; word-spacing: 5px;" class="box-title"><i class="fa fa-arrow-up"></i> Top Destination Sites</h3>
					<div class="box-tools pull-right">
						<button data-widget="collapse" class="btn btn-box-tool"><i class="fa fa-minus"></i></button>
						<button data-widget="remove" class="btn btn-box-tool"><i class="fa fa-times"></i></button>
					</div>
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
			<div class="info-box">
				<span class="info-box-icon"><i class="fa fa-usd green"></i></span>
				<div class="info-box-content">
					<!-- <span class="info-box-text">Inventory</span> -->
	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 style="color: black; word-spacing: 5px;" class="box-title"><i class="fa fa-tags"></i> Top Organic Keywords</h3>
					<div class="box-tools pull-right">
						<button data-widget="collapse" class="btn btn-box-tool"><i class="fa fa-minus"></i></button>
						<button data-widget="remove" class="btn btn-box-tool"><i class="fa fa-times"></i></button>
					</div>
		...
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">	
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 style="color: black; word-spacing: 5px;" class="box-title"><i class="fa fa-tags"></i> Top Paid Keywords</h3>
					<div class="box-tools pull-right">
						<button data-widget="collapse" class="btn btn-box-tool"><i class="fa fa-minus"></i></button>
						<button data-widget="remove" class="btn btn-box-tool"><i class="fa fa-times"></i></button>
					</div>
