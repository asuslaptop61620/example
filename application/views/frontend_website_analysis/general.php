	...
	<div id="hide_after_ajax">
		...
		<div class="row" style="padding-top:10px;">
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="info-box" style="border: 1px solid #ffffff;border-bottom: 3px solid #ffffff;">
							<span class="info-box-icon" style="height: 100px;background: #fff; border-right: 1px solid #ddd;"><i class="fa fa-link green"></i></span>
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="box box-primary">
							<div class="box-header with-border">
								<h3 class="box-title" style="color: black; word-spacing: 5px;"><img style="height:22px;margin-right: 5px;" src="<?php echo base_url();?>assets/images/moz.png" alt="SiteSpy" class="pull-left img-responsive">MOZ Information</h3>
								<div class="box-tools pull-right">
									<button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
								</div><!-- /.box-tools -->
							</div><!-- /.box-header -->
		...
		<div class="row" style="padding-top:10px;">
			...
			<div class="col-xs-12 col-md-4">
				...
				<div class="box box-warning">
					<div class="box-header with-border">
						<h3 class="box-title" style="color: black;"><i class="fa fa-shield"></i> Malware Scan Info</h3>
						<div class="box-tools pull-right">
							<button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
						</div><!-- /.box-tools -->
					</div><!-- /.box-header -->
				...
				<div class="box box-danger">
					<div class="box-header with-border">
						<h3 class="box-title" style="color: black;"><i class="fa fa-sort-numeric-asc"></i> Search Engine Index Info</h3>
						<div class="box-tools pull-right">
							<button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
						</div><!-- /.box-tools -->
					</div><!-- /.box-header -->
					...
					<div class="col-xs-12">
						<div class="box box-info">
							<div class="box-header with-border  table-responsive">
								<h3 class="box-title" style="color: black;"><i class="fa fa-clone"></i> Sites in Same IP</h3>
								<div class="box-tools pull-right">
									<button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
								</div><!-- /.box-tools -->
							</div><!-- /.box-header -->
			...
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
				<div class="row">
					<div class="col-xs-12">
						<div class="box box-info">
							<div class="box-header with-border  table-responsive">
								<h3 class="box-title" style="color: black;"><i class="fa fa-clone"></i> Related Websites</h3>
								<div class="box-tools pull-right">
									<button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
								</div><!-- /.box-tools -->
							</div><!-- /.box-header -->
