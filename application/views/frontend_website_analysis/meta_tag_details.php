...
<div class="row" style="margin-top: 10px;">
	<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
		<div class="box box-primary">
			<div class="box-header with-border">
				<h3 class="box-title" style="color: black; word-spacing: 3px;"><i class="fa fa-tags"></i> TITLE & METATAGS</h3>
	...
	<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
		<div class="well row" style="border-left:2px solid #ddd;-webkit-border-radius:5px;border-radius:5px;margin-left:0px;margin-right:0px;">
...
<div class="row" style="margin-top: 15px;">
	<div class="col-xs-12">
		<div class="box box-solid">
			<div class="box-header with-border">
				<h3 class="box-title"><i class="fa fa-html5"></i> HTML HEADINGS</h3>
				<div class="box-tools pull-right">
					<button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
				</div><!-- /.box-tools -->
			</div><!-- /.box-header -->
			<div class="box-body" style="background: white; color: black;">
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
					<h3 style="background: #E1E1E1;padding-left: 10px;padding: 5px 5px 5px 5px;">H1(<?php echo count($h1) ?>)</h3>
					<div class="yscroll" style="height: 230px; overflow-y: auto; padding-left: 10px;">
				...
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
					<h3 style="background: #E1E1E1;padding-left: 10px;padding: 5px 5px 5px 5px;">H2(<?php echo count($h2) ?>)</h3>
					<div class="yscroll" style="height: 230px; overflow-y: auto; padding-left: 10px;">
				...
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
					<h3 style="background: #E1E1E1;padding-left: 10px;padding: 5px 5px 5px 5px;">H3(<?php echo count($h3) ?>)</h3>
					<div class="yscroll" style="height: 230px; overflow-y: auto; padding-left: 10px;">
				...
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
					<h3 style="background: #E1E1E1;padding-left: 10px;padding: 5px 5px 5px 5px;">H4(<?php echo count($h4) ?>)</h3>
					<div class="yscroll" style="height: 230px; overflow-y: auto; padding-left: 10px;">
				...
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
					<h3 style="background: #E1E1E1;padding-left: 10px;padding: 5px 5px 5px 5px;">H5(<?php echo count($h5) ?>)</h3>
					<div class="yscroll" style="height: 230px; overflow-y: auto; padding-left: 10px;">
				...
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
					<h3 style="background: #E1E1E1;padding-left: 10px;padding: 5px 5px 5px 5px;">H6(<?php echo count($h6) ?>)</h3>
					<div class="yscroll" style="height: 230px; overflow-y: auto; padding-left: 10px;">
...
<div class="row" style="margin-top: 15px;">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="box box-warning">
			<div class="box-header with-border">
				<h3 class="box-title" style="color: black; word-spacing: 3px;"><i class="fa fa-key"></i> KEYWORD ANALYSIS</h3>
				<div class="box-tools pull-right">
					<button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
				</div><!-- /.box-tools -->
			</div><!-- /.box-header -->
			...
			<div class="box-body">
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 yscroll" style="height: 300px; overflow-y: auto;">
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 yscroll" style="max-height: 300px; overflow-y: auto;">
					<table class="table table-condensed table-striped">
						<tr>
				...
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 yscroll" style="height: 300px; overflow-y: auto; margin-top: 30px;">
					<table class="table table-condensed table-striped">
						<tr>
