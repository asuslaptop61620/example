...
<div class="container-fluid">
	...
	<div class="text-center" style="margin-top: 5px;padding:12px 0 8px 0 !important"><p style="color: <?php echo $THEMECOLORCODE; ?>; font-size: 28px; font-weight: bold;"><i class="fa fa-dashboard"></i> <?php echo $this->lang->line("Dashboard"); ?></p></div>
	...
	<div class="row" style="padding-left:12px;padding-right: 12px;">
		...
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="padding-left:3px;padding-right: 3px;">
			...
			<div href="http://facebook.com" style="background: #fff;padding:20px 0;margin:7px 2px;border-radius: 10px;min-height: 600px;" class="<?php if(count($day_wise_click_report_array)<1) echo "hidden"; ?>">
		...
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="padding-left:3px;padding-right: 3px;">
			...
			<div style="background: #fff;padding:20px 0;margin:7px 2px;border-radius: 10px;min-height: 600px;" class="<?php if(count($day_wise_click_report_array)<2) echo "hidden"; ?>">
		...
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">			
			...
			<div class="box">
				...
				<div class="box-header with-border">
					...
					<h3 class="box-title" style="color: <?php echo $THEMECOLORCODE; ?>"><i class="fa fa-bar-chart"></i> <?php echo $this->lang->line("Website Analysis"); ?></h3>
		...
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">			
			...
			<div class="box">
				...
				<div class="box-header with-border">
					...
					<h3 class="box-title" style="color: <?php echo $THEMECOLORCODE; ?>"><i class="fa fa-anchor"></i> <?php echo $this->lang->line("Link Analyzer"); ?></h3>
		...
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">			
			...
			<div class="box">
				...
				<div class="box-header with-border">
					...
					<h3 class="box-title" style="color: <?php echo $THEMECOLORCODE; ?>"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line("Search Engine Index"); ?></h3>
		...
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">			
			...
			<div class="box">
				...
				<div class="box-header with-border">
					...
					<h3 class="box-title" style="color: <?php echo $THEMECOLORCODE; ?>"><i class="fa fa-link"></i> <?php echo $this->lang->line("Google Backlink Search"); ?></h3>
		...
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">			
			...
			<div class="box">
				...
				<div class="box-header with-border">
					...
					<h3 class="box-title" style="color: <?php echo $THEMECOLORCODE; ?>"><i class="fa fa-globe"></i> <?php echo $this->lang->line('Similarweb Data'); ?></h3>
		...
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">			
			...
			<div class="box">
				...
				<div class="box-header with-border">
					...
					<h3 class="box-title" style="color:<?php echo $THEMECOLORCODE; ?>"><i class="fa fa-table"></i> <?php echo $this->lang->line("Alexa Data"); ?></h3>
