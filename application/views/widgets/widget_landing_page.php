...
<div class="row">
	...
	<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
		...
		<div class="col-xs-12" style="padding-right: 25px;">
			<div class="clearfix"><h1 style="margin: 0px;font-size: 18px"><?php echo $this->lang->line("Code"); ?></h1></div>
...
<script>
	$(document.body).on('click','#content_overview_button',function(){
		...
		if(domain_name == '') alertify.alert('<?php echo $this->lang->line("Alert") ?>','<?php echo $this->lang->line("Please Select Your Domain First !") ?>',function(){});
		else {
