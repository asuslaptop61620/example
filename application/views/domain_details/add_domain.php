			...
			<form class="form-horizontal" action="<?php echo site_url().'domain/add_domain_action';?>" method="POST">
				<div class="box-body">
					...
					<div class="form-group">
						<label class="col-sm-3 control-label" ><?php echo $this->lang->line('Add Domain'); ?>
						</label>
				...
				<div class="box-footer">
					<div class="form-group">
						<div class="col-sm-12 text-center">
							<button name="submit" id="submit" type="submit" class="btn btn-primary btn-lg"><i class="fa fa-hourglass-half"></i> <?php echo $this->lang->line("analyze");?></button>	
						    <button onclick='goBack("domain/domain_list_for_domain_details")' type="button" class="btn btn-default btn-lg"><i class="fa fa-close"></i> <?php echo $this->lang->line("cancel");?></button>
...
<div id="modal_add_domain" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="text-center">
					<h2 style="font-size: 14px!important;">Domain name :</h2>
					<span style="font-size: 14px!important;" id="domain_name_show"></span>
				</div>
...
<script type="text/javascript">
		...
		$.ajax({
			...
			success:function(response){
				...
				if(width==100) 
				{
					...
					$("#domain_success_msg").html('<center><h3 style="color:olive;font-size:14px;"><?php echo $this->lang->line("completed") ?></h3></center>');
	...
	$('#submit').click(function(e){
		...
		if(domain_name == '') {
			...
			$("#domain_success_msg").html('<img style="margin-top:20px;" class="center-block" src="'+base_url+'assets/pre-loader/Fancy pants.gif" alt="<?php echo $this->lang->line('please wait'); ?>"><br/>');
