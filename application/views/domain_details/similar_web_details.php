...
<div class="container-fluid">
		...
		<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
			<div style="border-bottom:2px solid #fff;" class="info-box">
				...
				<div class="info-box-content">
					<span class="info-box-text"><?php echo $this->lang->line('Category Rank'); ?></span>
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
			<div class="info-box">
				<span class="info-box-icon"><i class="fa fa-newspaper-o orange"></i></span>
				<div class="info-box-content">
					<!-- <span class="info-box-text">Inventory</span> -->
		...
		<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
			<div class="info-box">
				<span class="info-box-icon"><i class="fa fa-sign-out blue2"></i></span>
				<div class="info-box-content">
					<!-- <span class="info-box-text">Inventory</span> -->
	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 style="color: blue; word-spacing: 5px;" class="box-title"><i class="fa fa-globe"></i> <?php echo $this->lang->line('Traffic by Countries') ?></h3>
		...
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 style="color: blue; word-spacing: 5px;" class="box-title"><i class="fa fa-share-alt"></i> <?php echo $this->lang->line('Social Media Traffic'); ?></h3>
					<div class="box-tools pull-right">
						<button data-widget="collapse" class="btn btn-box-tool"><i class="fa fa-minus"></i></button>
						<button data-widget="remove" class="btn btn-box-tool"><i class="fa fa-times"></i></button>
					</div>
	...
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
			<div style="border:border-bottom:2px solid #fff;" class="info-box">
				<span class="info-box-icon"><i class="fa fa-arrow-right blue"></i></span>
				<div class="info-box-content">
					<span class="info-box-text"><?php echo $this->lang->line('Direct Traffic'); ?></span>
		...
		<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
			<div style="border-bottom:2px solid #fff;" class="info-box">
				<span class="info-box-icon"><i class="fa fa-arrow-down blue"></i></span>
				<div class="info-box-content">
					<span class="info-box-text"><?php echo $this->lang->line('Referral Traffic'); ?></span>
		...
		<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
			<div style="border-bottom:2px solid #fff;" class="info-box">
				<span class="info-box-icon"><i class="fa fa-search blue"></i></span>
				<div class="info-box-content">
					<span class="info-box-text"><?php echo $this->lang->line('Search Traffic'); ?></span>
		...
		<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
			<div style="border-bottom:2px solid #fff;" class="info-box">
				...
				<div class="info-box-content">
					<span class="info-box-text"><?php echo $this->lang->line('Social Traffic'); ?></span>
		...
		<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
			<div style="border-bottom:2px solid #fff;" class="info-box">
				<span class="info-box-icon"><i class="fa fa-envelope blue"></i></span>
				<div class="info-box-content">
					<span class="info-box-text"><?php echo $this->lang->line('Mail Traffic'); ?></span>
		...
		<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
			<div style="border-bottom:2px solid #fff;" class="info-box">
				<span class="info-box-icon"><i class="fa fa-laptop blue"></i></span>
				<div class="info-box-content">
					<span class="info-box-text"><?php echo $this->lang->line('Display Traffic'); ?></span>
	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 style="color: blue; word-spacing: 5px;" class="box-title"><i class="fa fa-arrow-down"></i> <?php echo $this->lang->line('Top Referral Sites'); ?></h3>
					<div class="box-tools pull-right">
						<button data-widget="collapse" class="btn btn-box-tool"><i class="fa fa-minus"></i></button>
						<button data-widget="remove" class="btn btn-box-tool"><i class="fa fa-times"></i></button>
					</div>
		...
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">	
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 style="color: blue; word-spacing: 5px;" class="box-title"><i class="fa fa-arrow-up"></i> <?php echo $this->lang->line('Top Destination Sites'); ?></h3>
					<div class="box-tools pull-right">
						<button data-widget="collapse" class="btn btn-box-tool"><i class="fa fa-minus"></i></button>
						<button data-widget="remove" class="btn btn-box-tool"><i class="fa fa-times"></i></button>
					</div>
	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 style="color: blue; word-spacing: 5px;" class="box-title"><i class="fa fa-tags"></i> <?php echo $this->lang->line('Top Organic Keywords'); ?></h3>
					<div class="box-tools pull-right">
						<button data-widget="collapse" class="btn btn-box-tool"><i class="fa fa-minus"></i></button>
						<button data-widget="remove" class="btn btn-box-tool"><i class="fa fa-times"></i></button>
					</div>
		...
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">	
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 style="color: blue; word-spacing: 5px;" class="box-title"><i class="fa fa-tags"></i> <?php echo $this->lang->line('Top Paid Keywords'); ?></h3>
					<div class="box-tools pull-right">
						<button data-widget="collapse" class="btn btn-box-tool"><i class="fa fa-minus"></i></button>
						<button data-widget="remove" class="btn btn-box-tool"><i class="fa fa-times"></i></button>
					</div>
