...
<h1><i class="fa fa-bar-chart"></i> <?php echo $this->lang->line('website analysis'); ?> </h1>
  ...
  <div class="row">
    <div class="col-xs-12">
       ...
       <div id="tb" style="padding:3px">
	       	...
	       	<a class="btn btn-primary"  title="<?php echo $this->lang->line('analyze website'); ?>" href="<?php echo site_url('domain/add_domain');?>">
...
<script>       
    ...
    {               
        ...
        str="<a title='"+more+"' style='cursor:pointer' class='btn btn-outline-primary' href='"+details_url+"'><i class='fa fa-eye'></i></a>";
        ...
        str=str+"&nbsp;<a id='download_pdf' title='"+download_title+"' table_id="+row.id+" style='cursor:pointer' class='btn btn-outline-success'><i class='fa fa-cloud-download'></i></a>";
...
<!-- Modal for download -->
<div id="modal_for_download" class="modal fade" data-backdrop="static" data-keyboard="false">
