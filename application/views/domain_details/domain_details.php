<style type="text/css">
	...
	.tabs-below > .nav-tabs > li > a:focus {
	  ...
	  border-top:2px solid <?php echo $THEMECOLORCODE; ?>;
	}
...
<div class="well well_border_left"> <h4 class="text-center"> <i class="fa fa-globe"></i> <?php echo "Domain Name - ".$domain_info[0]['domain_name']; ?></h4> </div>
		...
		<div class="col-xs-12">			
			<div class="tabs-below">
				...
				<ul class="nav nav-tabs" role="tablist">
					<li role="presentation" class="active"><a href="#general" aria-controls="general" role="tab" data-toggle="tab"><?php echo $this->lang->line('General'); ?></a></li>
					<li role="presentation" ><a href="#social_network" aria-controls="social_network" role="tab" data-toggle="tab"><?php echo $this->lang->line('Social Network Information'); ?></a></li>
					<li role="presentation" ><a href="#meta_tag_info" aria-controls="meta_tag_info" role="tab" data-toggle="tab"><?php echo $this->lang->line('Keyword & Meta Information'); ?></a></li>
					<li role="presentation" ><a href="#alexa_info" aria-controls="alexa_info" role="tab" data-toggle="tab"><?php echo $this->lang->line('Alexa Information'); ?></a></li>
					<li role="presentation" ><a href="#similarweb_info" aria-controls="similarweb_info" role="tab" data-toggle="tab"><?php echo $this->lang->line('SimilarWeb Information'); ?></a></li>
