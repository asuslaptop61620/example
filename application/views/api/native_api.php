<div class="well well_border_left">
	<h4 class="text-center"> <i class="fa fa-key"></i> <?php echo $this->lang->line("Api Keys"); ?></h4>
</div>
...
<section class="content-header">
   <section class="content">
		...
		<div class="well" style="background:#F9F2F4;margin-top:0;border-radius:0;;">
			<h4>API HTTP URL: </h4> <?php echo site_url();?>native_api/facebook_ckeck?api_key=YOUR_API_KEY&domain=ANY_WEBSITE_DOMAIN
			<hr/>
