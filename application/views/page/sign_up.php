      ...
      <div class="logmod__tab lgm-2">
        <div class="logmod__heading">
          ...
          <?php 
            ...
            if(form_error('name') != '' || form_error('mobile') !='' || form_error('email') != '' || form_error('confirm_password') != '' ||form_error('password')!="" ) 
            {
              $form_error="";
        ...
        <div class="logmod__form">
          <form accept-charset="utf-8" action="<?php echo site_url('home/sign_up_action');?>" method="post" class="simform">
            ...
            <div class="sminputs">
              <div class="input full">
                <label class="string optional" for="mobile-no"><?php echo $this->lang->line("mobile"); ?></label>
