          ...
          <div class="box box-primary" style='border-bottom:4px solid <?php echo $THEMECOLORCODE ?>;margin-top:10px;'>
            <div class="box-header ui-sortable-handle" style="cursor: move;">
              ...
              <div class="box-tools pull-right">
                <?php 
                if($value['installed']=="0") echo "<span class='label label-light pull-right' style='margin-top:15px;'><i class='fa fa-remove'></i> ".$this->lang->line("inactive")."</span>";
                else echo "<span class='label label-light pull-right' style='margin-top:15px;'><i class='fa fa-check'></i> ".$this->lang->line("active")."</span>"; 
                ?> 
              </div>
            </div>
            ...
            <div class="box-footer clearfix no-border text-center">             
              ...
              <?php if($value['installed'] == '1'): ?>
                <a title="<?php echo $this->lang->line("deactivate"); ?>" class="btn btn-outline-primary pull-left deactivate_action" data-i='<?php echo $i; ?>' data-href="<?php echo $module_controller.'/deactivate';?>"><i class="fa fa-ban"></i> <?php echo $this->lang->line('deactivate');?></a>
              <?php endif; ?>
              <a title="<?php echo $this->lang->line("delete"); ?>" class="btn btn-outline-danger pull-right delete_action" data-i='<?php echo $i; ?>' data-href="<?php echo $module_controller.'/delete';?>"><i class="fa fa-trash"></i> <?php echo $this->lang->line('delete');?></a>
            </div>
          </div>
        </div>            
        <?php 
