				...
				<form enctype="multipart/form-data" method="post" class="form-inline" id="new_search_form" style="margin-bottom:10px">
					...
					<div class="row">						
						<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<label style="color: <?php echo $THEMECOLORCODE; ?>"><i class="fa fa-globe"></i> <?php echo $this->lang->line(" Domain Name(s)"); ?><br/></label>
					...
					<div class="row" style="margin-top: 10px;">						
						...
						<div class="form-group col-xs-12 col-sm-12 col-md-7 col-lg-7 clearfix">						
							<button class='btn btn-outline-success'  id ="pull_data"><i class="fa fa-upload"></i> </i> <?php echo $this->lang->line("upload file"); ?></button>     
							<button type="button"  id="new_search_button" class="btn btn-primary pull-right"><i class="fa fa-search"></i> <?php echo $this->lang->line("start scanning"); ?></button>   
						</div>
					</div>
...
<script>
	...
	$j("document").ready(function(){
		...
		$("#new_search_button").on('click',function(){
			...
			{
				alertify.alert('<?php echo $this->lang->line("Alert") ?>','<?php echo $this->lang->line("please select antivirus"); ?>',function(){});
				return false;
			}
