...
<section class="content-header">
	<h1 class = 'text-info'><i class="fa fa-shield"></i> <?php echo $this->lang->line("VirusTotal Scan");?></h1>
</section>
				 	...
				 	<form class="form-horizontal" method="POST" nctype="multipart/form-data"  id="new_search_form" style="margin-bottom:10px">
						<div class="form-group">
							...
							<div class="col-sm-12 col-md-4">
								<button type="button"  id="new_search_button" class="btn btn-primary"><i class="fa fa-search"></i> <?php echo $this->lang->line("start scanning"); ?></button>
							</div>
						</div>        
					</form>
				 <!-- </div> -->
