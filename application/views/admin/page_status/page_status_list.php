...
<section class="content-header">
	<h1 class = 'text-info'><i class="fa fa-anchor"></i> <?php echo $this->lang->line("page status check");?></h1>
</section>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 id="new_search_details_title" class="modal-title"><i class="fa fa-anchor"></i> <?php echo $this->lang->line("page status check");?></h4>
			</div><br/>
