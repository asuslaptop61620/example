...
<section class="content-header">
	<h1 class = 'text-info'><i class="fa fa-link"></i> <?php echo $this->lang->line("backlink generator");?></h1>
</section>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 id="new_search_details_title" class="modal-title"><i class="fa fa-link"></i> <?php echo $this->lang->line("backlink generator");?></h4>
			</div><br/>
				...
				<form enctype="multipart/form-data" method="post" class="form-inline" id="new_search_form" style="margin-bottom:10px">
					<div class="row">						
						<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<label style="color: <?php echo $THEMECOLORCODE; ?>"><i class="fa fa-globe"></i> <?php echo $this->lang->line('Domain Name(s)'); ?></label><br/>
					...
					<div class="row">
						...
						<div class="form-group col-xs-12 col-sm-12 col-md-7 col-lg-7 clearfix">						
							<button class='btn btn-outline-success'  id ="pull_data"><i class="fa fa-upload"></i> Upload File</button>
							<button type="button"  id="new_search_button" class="btn btn-primary pull-right"><i class="fa fa-undo"></i> <?php echo $this->lang->line("start generation");?></button>   
						</div>
					</div>
