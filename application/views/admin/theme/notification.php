    ...
    <li class="dropdown user user-menu">
      ...
      <ul class="dropdown-menu">
        ...
        <li class="user-footer border_gray">
          <div class="pull-left">
            <a href="<?php echo site_url('change_password/reset_password_form') ?>" class="btn btn-outline-danger btn-flat"><i class="fa fa-key"></i> <?php echo $this->lang->line("change password"); ?></a>
          </div>
          <div class="pull-right">
            <a href="<?php echo site_url('home/logout') ?>" class="btn btn-outline-primary btn-flat"><i class="fa fa-sign-out"></i><?php echo $this->lang->line("logout"); ?></a>
          </div>
        </li>
      </ul>
    </li>
