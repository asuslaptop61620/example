...
<section class="content-header">
	<h1 class = 'text-info'><i class="fa fa-server"></i> <?php echo $this->lang->line("whois search");?></h1>
</section>
	...
	<div class="row" >
		<div class="col-xs-12">
			...
			<form class="form-inline" style="margin-top:20px">
				...
				<button type="button" style="width:200px;" class="btn btn-outline-warning download" id = "download_btn_all"><i class="fa fa-cloud-download"></i> <?php echo $this->lang->line("download all");?>l</button>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 id="new_search_details_title" class="modal-title"><i class="fa fa-server"></i> <?php echo $this->lang->line("whois search");?></h4>
			</div><br/>
...
<script>
	...
	$(".download").click(function(){
		...
		if(rows == '' && all==0)
		{
			...
			alertify.alert('<?php echo $this->lang->line("Alert") ?>','<?php echo $this->lang->line("You have not select any record");?>');
			return false;
		}
		$.ajax({
			type:'POST',
