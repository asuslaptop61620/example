...
<section class="content-header">
	<h1 class = 'text-info'><i class="fa fa-map-marker"></i> <?php echo $this->lang->line("sites in same ip");?></h1>
</section>
...
<script>
	...
	$j("document").ready(function(){
		...
		$("#new_search_button").on('click',function(){
			...
			if(urls=='')
			{
				alertify.alert('<?php echo $this->lang->line("Alert") ?>','<?php echo $this->lang->line("please enter IP"); ?>',function(){});
				return false;
			}
