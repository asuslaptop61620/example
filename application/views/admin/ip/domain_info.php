...
<section class="content-header">
	<h1 class = 'text-info'><i class="fa fa-map-marker"></i> <?php echo $this->lang->line("domain ip information");?></h1>
</section>
				...
				>
					...
					<thead>
						<tr>
							...
							<th field="organization" sortable="true">Organization</th>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 id="new_search_details_title" class="modal-title"><i class="fa fa-map-marker"></i> <?php echo $this->lang->line("domain ip information");?></h4>
			</div><br/>
