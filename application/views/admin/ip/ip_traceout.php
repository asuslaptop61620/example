...
<div class="row" style="margin-top: 20px;">
	<div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3 well" style="padding-bottom: 20px;background: #fff;">
		<br><h2 class="text-center dynamic_font_color" style="margin-bottom: 15px; margin-top: 0px;font-size: 18px;"><i class="fa fa-map-marker"></i> <?php echo $this->lang->line("IP Traceout");?></h2><hr><br>
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
				<button class="btn btn-primary"  id="ip_address_search"><i class="fa fa-hourglass-half"></i> <?php echo $this->lang->line("Start Tracing");?></button>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12">				
				<a class="label label-info" href="<?php echo site_url()."ip/domain_info"; ?>"><?php echo $this->lang->line("Get Your Domain IP");?></a>
			</div>
		</div>
