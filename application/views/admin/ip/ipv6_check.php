...
<section class="content-header">
	<h1 class = 'text-info'><i class="fa fa-map-marker"></i> <?php echo $this->lang->line("ipv6 compability check");?></h1>
</section>
...
<script>
	...
	$(".download").click(function(){
		...
		if(rows == '' && all==0)
		{
			...
			alertify.alert('<?php echo $this->lang->line("You have not select any record") ?>','<?php echo $this->lang->line("You have not select any record");?>',function(){});
			return false;
		}
		$.ajax({
			type:'POST',
