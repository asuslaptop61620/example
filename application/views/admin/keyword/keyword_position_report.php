	...
	<section class="content">
		<div class="row">
			<div class="well col-xs-12 col-sm-12 col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3">
				<p class="text-center dynamic_font_color" style="font-size: 18px;"><b><i class="fa fa-tags"></i>	<?php echo $this->lang->line("Keyword Position Report")." - ".$this->lang->line("Search Panel"); ?></b></p>
				<form method="POST">
					...
					<div class="form-group col-xs-12 col-sm-12 col-md-4 col-md-offset-4 col-lg-4 col-lg-offset-4">
						<button id="search" class="btn btn-primary" style="width: 100%;"><i class="fa fa-search"></i> <?php echo $this->lang->line("Search"); ?></button>
					</div>
...
<script>
    ...
    $(document.body).on('click','#search',function(e){
    		...
    		if(keyword == '' || from_date == '' || to_date == '')
    			alertify.alert('<?php echo $this->lang->line("Alert") ?>','<?php echo $this->lang->line("something is missing");?>',function(){});
    		else{
    			$.ajax({
			        type:'POST',
			        async:false,
