...
<section class="content-header">
	<h1 class = 'text-info'><i class="fa fa-eye"></i> <?php echo $this->lang->line("Keyword Tracking Settings");?> </h1>
</section>
		...
		<div class="col-xs-12">
			...
			<div id="tb" style="padding:3px">
				...
				<?php if($number_of_keyword < 3) { ?>
					<a style="margin-bottom: 5px;" class="btn btn-primary"  title="<?php echo $this->lang->line("add"); ?>" href="<?php echo site_url('keyword_position_tracking/keyword_tracking_settings');?>">
...
<script>
    ...
    {               
        ...
        str=str+"&nbsp;<a class='btn btn-outline-danger are_you_sure' style='cursor:pointer' title='Delete' href='"+delete_url+"'>"+'<i class="fa fa-trash"></i>'+"</a>";
