...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2 well">
		<div class='text-center'><h4 class="text-info"><strong><i class="fa fa-google"></i> <?php echo $this->lang->line("correlated keywords");?></strong></h4></div>
		<form enctype="multipart/form-data" method="post" class="form-inline" id="new_search_form" style="margin-top:60px margin-left:10px">
			...
			<div class="row">
				<div class="form-group col-xs-12 clearfix  text-center">    
					<button type="button"  id="new_search_button" class="btn btn-primary"><i class="fa fa-search"></i> <?php echo $this->lang->line("start searching");?></button>
				</div>
...
$j("document").ready(function(){
		...
		$("#new_search_button").on('click',function(){
			...
			if(keyword=='')
			{
				alertify.alert('<?php echo $this->lang->line("Alert") ?>','<?php echo $this->lang->line("please enter keyword");?>',function(){});
				return false;
			}

			if(country=='')
			{
				alertify.alert('<?php echo $this->lang->line('Alert') ?>','<?php echo $this->lang->line("you have not select any country");?>',function(){});
				return false;
			}
...
<div id="modal_result" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
