...
<div class="row">
	...
	<div class="well well_border_left">
		<h4 class="text-center"> <i class="fa fa-globe"></i> <?php echo "Domain Name - ".$domain_name; ?></h4>
	</div>
</div>
<div class="row" style="margin-top: 10px;">
	<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
		<div class="box box-primary">
			<div class="box-header with-border">
				<h3 class="box-title" style="color: blue; word-spacing: 3px;"><i class="fa fa-code"></i> TITLE & METATAGS</h3>
	...
	<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
		<div class="well row" style="border-left:2px solid #ecf0f5;-webkit-border-radius:5px;border-radius:5px;margin-left:0px;margin-right:0px;">
...
<div class="row" style="margin-top: 15px;">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="box box-warning">
			<div class="box-header with-border">
				<h3 class="box-title" style="color: blue; word-spacing: 3px;"><i class="fa fa-tags"></i> KEYWORD ANALYSIS</h3>
				<div class="box-tools pull-right">
					<button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
				</div><!-- /.box-tools -->
			</div><!-- /.box-header -->
