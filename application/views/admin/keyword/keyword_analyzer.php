<div class="row" style="margin-top: 20px;">
	<div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3 well" style="padding-bottom: 20px;">
		<h2 class="text-center dynamic_font_color" style="margin-bottom: 30px; margin-top: 0px;font-size: 18px"><i class="fa fa-tags"></i> <?php echo $this->lang->line("keyword analyzer");?></h2>
		...
		<div>
			...
			<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
				<button class="btn btn-primary"  id="keyword_domain_search"><i class="fa fa-hourglass-half"></i> <?php echo $this->lang->line("start analysis");?></button>
			</div>
		</div>
		<br/><br/><br/><br/>
...
<script>
	$(document.body).on('click','#keyword_domain_search',function(){
		...
		if(domain_name == '') alertify.alert('<?php echo $this->lang->line("Alert") ?>','<?php echo $this->lang->line("you have not enter any domain name"); ?>',function(){});
