				...
				<div class="box-footer">
					<div class="form-group">
						<div class="col-sm-12 text-center">							
							...
							<button onclick='goBack("keyword_position_tracking/keyword_list")' type="button" class="btn btn-default btn-lg"><i class="fa fa-close"></i> <?php echo $this->lang->line("cancel");?></button>
						</div>
					</div>
				</div><!-- /.box-footer -->         
			</div><!-- /.box-info -->       
