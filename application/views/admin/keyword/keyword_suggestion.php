...
<section class="content-header">
	<h1 class = 'text-info'><i class="fa fa-tags"></i> <?php echo $this->lang->line("keyword auto suggestion");?> </h1>
</section>
<section class="content">  
	<div class="row" >
		<div class="col-xs-12">
			<div class="grid_container" style="width:100%; min-height:720px;">
				<table 
				id="tt"  
...
<script>
	...
	$j("document").ready(function(){
		...
		$("#new_search_button").on('click',function(){
			...
			{
				alertify.alert('<?php echo $this->lang->line("Alert") ?>','<?php echo $this->lang->line("please select search engine"); ?>',function(){});
				return false;
			}
