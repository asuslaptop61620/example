...
<section class="content-header">
	...
	<h1 class = 'text-info'><i class="fa fa-cut"></i> <?php echo $this->lang->line("bitly url shortener");?></h1>
				...
				<form enctype="multipart/form-data" method="post" class="form-inline" id="new_search_form" style="margin-bottom:10px">
					...
					<div class="row">						
						...
						<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<label style="color: <?php echo $THEMECOLORCODE; ?>"><i class="fa fa-globe"></i> <?php echo $this->lang->line("Enter your original url here");?><br/></label>
					...
					<div class="row" style="margin-top: 10px;">						
						...
						<div class="form-group col-xs-12 col-sm-12 col-md-7 col-lg-7 clearfix">						
							...
							<button type="button"  id="new_search_button" class="btn btn-primary pull-right"><i class="fa fa-binoculars"></i> <?php echo $this->lang->line("start shortening"); ?></button>   
