<?php 
    ...
    if(isset($url_details_refferar_month['data']['referrers'])){
       $monthly_referrer_str = "<table class='table table-striped'> <tr><th>Referrer</th><th>Click</th></tr>";
     $monthly_referrers = $url_details_refferar_month['data']['referrers'];
       foreach($monthly_referrers as $monthly_referrer)
       {
           $monthly_referrer_str .= "<tr><td>".$monthly_referrer['referrer']."</td><td>".$monthly_referrer['clicks']."</td></tr>";
       }
       $monthly_referrer_str .= "</table>";
       $table_for_monthly_referrer = $monthly_referrer_str;

    }
    $table_for_monthly_refferr_domain = "";
    if(isset($url_details_domain_month['data']['referring_domains'])){
       $monthly_referrer_str = "<table class='table table-striped'> <tr><th>Domain</th><th>Click</th></tr>";
	   $monthly_referrers = $url_details_domain_month['data']['referring_domains'];
       foreach($monthly_referrers as $monthly_referrer)
       {
           $monthly_referrer_str .= "<tr><td>".$monthly_referrer['domain']."</td><td>".$monthly_referrer['clicks']."</td></tr>";
       }
       $monthly_referrer_str .= "</table>";
       $table_for_monthly_refferr_domain = $monthly_referrer_str;
    ...
    if(isset($url_details_country_month['data']['countries'])){
       $monthly_country_str = "<table class='table table-striped'> <tr><th>Country</th><th>Click</th></tr>";
	   $monthly_countries = $url_details_country_month['data']['countries'];
       foreach($monthly_countries as $monthly_country)
       {
          if(isset($array_countries[$monthly_country['country']]))
            $m_country = $array_countries[$monthly_country['country']];
          else
            $m_country = $monthly_country['country'];

          $monthly_country_str .= "<tr><td>".$m_country."</td><td>".$monthly_country['clicks']."</td></tr>";
       }
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 style="color: blue; word-spacing: 4px;" class="box-title"><i class="fa fa-globe"></i> <?php echo $this->lang->line('Referral domain'); ?></h3>
            ...
            <div class="box-body">
                        <div class="table table-responsive" style="height:300px;">
                            <?php echo $table_for_monthly_refferr_domain; ?>
                        </div>
            </div>
          </div> <!-- end box -->     
        </div>
