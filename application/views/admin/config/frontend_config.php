			        			...
			        			<fieldset style="padding:30px; min-height: 220px;">
			        				<legend class="block_title"><i class="fa fa-wrench"></i> <?php echo $this->lang->line('general settings'); ?></legend>
						           	...
						           	<div class="form-group">
										...
										echo form_dropdown('display_landing_page',array('1'=>$this->lang->line('yes'),'0'=>$this->lang->line('no')),$display_landing_page,'class="form-control" id="display_landing_page"');  ?>		          
						           ...
						           <div class="form-group">
						             	<label for=""><i class="fa fa-bar-chart"></i> <?php echo $this->lang->line("front-end website analysis search");?>
						             	</label>
				               			<?php	
				               			$front_end_search_display = $this->config->item('front_end_search_display');
				               			if($front_end_search_display == '') $front_end_search_display='0';
				               			
										echo form_dropdown('front_end_search_display',array('1'=>$this->lang->line('Show'),'0'=>$this->lang->line("Don't show")),$front_end_search_display,'class="form-control" id="front_end_search_display"');  ?>		          
		        			...
		        			<div class="col-xs-12 col-md-6">
				        		<fieldset style="padding:30px;min-height: 220px;">
									...
									<div class="row">
										...
										<div class="col-xs-12 col-md-6">
								            <div class="form-group">
								             	<label for=""><i class="fa fa-reddit"></i> <?php echo $this->lang->line("Reddit");?></label>
								             	<input name="reddit_link" value="<?php echo $this->config->item('reddit');?>" class="form-control" type="text">		          
						             			<span class="red"><?php echo form_error('reddit_link'); ?></span>           			
								            </div>
								        </div>

				        				<div class="col-xs-12 col-md-6">
				        		            <div class="form-group">
				        		             	<label for=""><i class="fa fa-pinterest"></i> <?php echo $this->lang->line("Pinterest");?></label>
				        		             	<input name="pinterest_link" value="<?php echo $this->config->item('pinterest');?>" class="form-control" type="text">		          
				                     			<span class="red"><?php echo form_error('pinterest_link'); ?></span>           			
				        		            </div>
				        		        </div>
			        			...
			        			<fieldset class="review_block" style="padding:30px;">
			        				<legend class="block_title"><i class="fa fa-smile"></i> <?php echo $this->lang->line('review settings'); ?></legend>
						           	...
						           	<div class="form-group">
										...
										echo form_dropdown('display_review_block',array('1'=>$this->lang->line('yes'),'0'=>$this->lang->line('no')),$display_review_block,'class="form-control" id="display_review_block"');  ?>	          
		        			...
		        			<div class="col-xs-12 col-md-6">
				        		<fieldset class="video_block" style="padding:30px;">
				        			<legend class="block_title"><i class="fa fa-video-camera"></i> <?php echo $this->lang->line('video Settings'); ?></legend>
										...
										echo form_dropdown('display_video_block',array('1'=>$this->lang->line('yes'),'0'=>$this->lang->line('no')),$display_video_block,'class="form-control" id="display_video_block"'); ?>		          
