...
<section class="content-header">
   <section class="content">
     	<div class="box box-info custom_box">
		    ...
		    <form style="color: #607D8B !important;" class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url().'admin_config_ad/edit_ad_config';?>" method="POST">
		        <div class="box-body">
		           	...
		           	<div class="box-footer">
		            	<div class="form-group">
		             		<div class="col-sm-12 text-center">
		               			...
		               			<button onclick='goBack("admin_config_ad/index",1)' type="button" class="btn btn-default btn-lg"><i class="fa fa-close"></i> <?php echo $this->lang->line("Cancel");?></button>
