...
<section class="content-header">
	<h1 class = 'text-info'><i class="fa fa-link"></i> <?php echo $this->lang->line("website ping");?></h1>
</section>
				...
				<form enctype="multipart/form-data" method="post" class="form-inline" id="new_search_form" style="margin-bottom:10px">
					...
					<div class="row">
						<div class="form-group col-xs-12 col-sm-12 col-md-7 col-lg-7 clearfix">						
							<button type="button"  id="new_search_button" class="btn btn-primary pull-right"><i class="fa fa-link"></i> <?php echo $this->lang->line("ping website");?></button>   
						</div>
					</div>
