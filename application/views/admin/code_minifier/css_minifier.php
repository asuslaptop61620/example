         ...
         <div class="box-body">	  
         	...
         	<div class="form-group">
	             ...
	             <div class="col-sm-8 col-md-8 col-lg-8">
	             	...
	             	<button type="button" class="btn btn-primary" id="minify_css"><?php echo $this->lang->line('minify the above code');?></button><br/>
	             </div>
            </div>
...
$j("document").ready(function(){
	...
	$(document.body).on('click','#minify_css',function(){
		...
		if(css_code==''){
			alertify.alert('<?php echo $this->lang->line("Alert") ?>','<?php echo $this->lang->line("Please write your css code first");?>',function(){});
			return false;
		}
