         ...
         <div class="box-body">	  
         	...
         	<div class="form-group">
	             ...
	             <div class="col-sm-8 col-md-8 col-lg-8">
	             	...
	             	<button type="button" class="btn btn-primary" id="minify_html"><?php echo $this->lang->line('minify the above code');?></button><br/>
	             </div>
            </div>
...
$j("document").ready(function(){
	...
	$(document.body).on('click','#minify_html',function(){
		...
		if(html_code==''){
			alertify.alert('<?php echo $this->lang->line("Alert") ?>','<?php echo $this->lang->line("Please write your html code first");?>',function(){});
			return false;
		}
