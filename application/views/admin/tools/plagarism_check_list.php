...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2 well">
		<div class='text-center'><h4 class="text-info"><strong><i class="fa fa-language"> </i> <?php echo $this->lang->line("Plagiarism Check"); ?></strong></h4></div>
...
$j("document").ready(function(){
		...
		$("#new_search_button").on('click',function(){
			...
			if(emails==''){
				alertify.alert('<?php echo $this->lang->line("Alert") ?>','<?php echo $this->lang->line("please enter your text"); ?>',function(){});
				return false;
			}
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 id="new_search_details_title" class="modal-title"><i class="fa fa-language"></i> <?php echo $this->lang->line("Plagiarism Check"); ?></h4>
			</div><br/>
