...
<section class='content'>
	...
	<div class='row'>
		<div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2 well">
			...
			<div class='text-center'><h4 class="text-info"><strong><i class="fa fa-link"></i> <?php echo $this->lang->line("URL Canonical Check");?></strong></h4></div>
			...
			<div class='form-group'>
				<button id='searchCanonical' class='btn btn-primary'><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('Check'); ?></button>				
			</div>
