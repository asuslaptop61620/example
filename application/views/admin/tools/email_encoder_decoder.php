...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2 well">
		<div class='text-center'><h4 class="text-info"><strong><i class="fa fa-code"></i> <?php echo $this->lang->line("email encoder/decoder");?></strong></h4></div>
		<form enctype="multipart/form-data" method="post" class="form-inline text-center" id="new_search_form" style="margin-top:60px margin-left:10px">
			...
			<div class="row" style="margin-top: 10px;">						
				...
				<div class="form-group col-xs-9 clearfix">
					...
					<button type="button"  id="new_search_button" class="btn btn-primary "><i class="fa fa-code"></i> <?php echo $this->lang->line("start encoding"); ?></button>
					<button type="button"  id="new_search_button_decode" class="btn btn-warning pull-right"><i class="fa fa-exchange"></i> <?php echo $this->lang->line("start decoding"); ?></button>
				</div>
...
$j("document").ready(function(){
		...
		$("#new_search_button").on('click',function(){
			...
			if(emails==''){
				alertify.alert('<?php echo $this->lang->line("Alert") ?>','<?php echo $this->lang->line("please enter your emails"); ?>',function(){});
				return false;
			}
...
<div id="modal_valid_email_result" class="modal fade" data-backdrop="static" data-keyboard="false" style="left: -180px!important;">
	<div class="modal-dialog">
		<div class="modal-content modal-lg">
			...
			<div class="modal-header">
				...
				<h4 id="new_search_details_title" class="modal-title"><i class="fa fa-envelope"></i> <?php echo $this->lang->line("email encoder/decoder");?></h4>
			</div><br/>
