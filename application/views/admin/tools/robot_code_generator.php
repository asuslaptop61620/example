   ...
   <section class="content">
     <div class="box box-info custom_box">
       ...
       <!-- form start -->
        ...
        <!--  *****************************************************************************************************  -->   
        <hr/>
          <center><h2 class="text-info"><?php echo $this->lang->line("OR"); ?></h2></center>
          <center><button id="custom_robot"  class="btn btn-outline-primary"><i class="fa fa-search"></i> <?php echo $this->lang->line('Specific Search Robots'); ?></button></center>
        <div id = "custom_setting" style = 'display:none'>
         ...
         <hr/>
          <h4 class="text-center"><label class="control-label orange"><?php echo $this->lang->line('Specific Special Bots'); ?></label></h4>
         ...
         <!--   this is the seperator section ******************************** -->
          ...
          <center><button type="button" id="btn2" class="btn btn-primary"><i class='fa fa-plus-circle'></i> <?php echo $this->lang->line('Add Directories'); ?></button></center><br/>
          ...
          <center><button id="close_custom_robot"  class="btn btn-warning"><i class="fa fa-close"></i> <?php echo $this->lang->line('Close Specific Search Robots'); ?></button></center> 
          </div>               
         ...
         <div class="box-footer" style="margin-top: 20px;">
            <div class="form-group">
             <div class="col-sm-12 text-center">
               <button id="submit" type="submit" class="btn btn-primary btn-lg"><i class="fa fa-save"></i> <?php echo $this->lang->line("save"); ?></button> 
            
              <button onclick='goBack("tools/robot_code_generator",0)' type="button" class="btn btn-default btn-lg"><i class="fa fa-close"></i> <?php echo $this->lang->line('cancel'); ?></button>  
             </div>
           </div>                  
         </div><!-- /.box-footer -->         
         </div><!-- /.box-info -->   
