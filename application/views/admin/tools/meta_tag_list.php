         ...
         <div class="box-footer">
            <div class="form-group">
             <div class="col-sm-12 text-center">
               ...
               <button id="submit" type="submit" class="btn btn-primary btn-lg"><i class="fa fa-marker"></i> <?php echo $this->lang->line('generate'); ?></button> 

              <button onclick='goBack("tools/meta_tag_list",0)' type="button" class="btn btn-default btn-lg"><i class="fa fa-close"></i><?php echo $this->lang->line('cancel'); ?></button>  
             </div>
           </div>                  
         </div><!-- /.box-footer -->         
         </div><!-- /.box-info -->   
...
$(document.body).on('click','#submit',function(){ 
  ...
  if(is_google ==0 && is_twiter ==0 && is_facebook == 0)
   alertify.alert('<?php echo $this->lang->line("Alert") ?>','<?php echo $this->lang->line("one or more required fields are missing"); ?>',function(){});
...
<div id="modal_unique_email_result" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 id="new_search_details_title" class="modal-title"><i class="fa fa-tags"></i> <?php echo $this->lang->line("Metatag Generator"); ?></h4>
      </div><br/>
