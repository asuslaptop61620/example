...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2 well">
		<div class='text-center'><h4 class="text-info"><strong><i class="fa fa-code"></i> <?php echo $this->lang->line("Base64 Encoder/Decoder"); ?></strong></h4></div>
		<form enctype="multipart/form-data" method="post" class="form-inline text-center" id="new_search_form" style="margin-top:60px margin-left:10px">
			...
			<div class="row">						
				...
				<div class="form-group col-xs-12 clearfix">
					...
					<button type="button"  id="new_search_button_decode" class="btn btn-primary"><i class="fa fa-exchange"></i> <?php echo $this->lang->line("start decoding"); ?></button>
				</div>
...
$j("document").ready(function(){
	...
	$("#new_search_button").on('click',function(){
		...
		if(base64==''){
			alertify.alert('<?php echo $this->lang->line("Alert") ?>','<?php echo $this->lang->line("You have not enter any content") ?>',function(){});
			return false;
		}
...
<div id="modal_base64" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 id="new_search_details_title" class="modal-title"><i class="fa fa-code"></i> <?php echo $this->lang->line("Base64 Encoder/Decoder"); ?></h4>
			</div><br/>
