         ...
         <div class="box-body">
          ...
          <div class="form-group">
             ...
             <table class="table table-bordered table-condensed table-hover table-striped" style="width:auto;">
              <tr>
               <td colspan="5"><input  id="all_modules" type="checkbox"/> <font color="<?php echo $THEMECOLORCODE; ?>">&nbsp;&nbsp;&nbsp;&nbsp;<b><?php echo $this->lang->line("All Modules"); ?></b></font> [<?php echo $this->lang->line("0 means unlimited");?>]</td>
              </tr>
               <?php                   
           ...
           <div class="box-footer">
            <div class="form-group">
             <div class="col-sm-12 text-center">
               ...
               <button onclick='goBack("payment/package_settings",0)' type="button" class="btn btn-default btn-lg"><i class="fa fa-close"> </i><?php echo $this->lang->line('cancel'); ?></button>
             </div>
           </div>
         </div><!-- /.box-footer -->         
         </div><!-- /.box-info -->       
