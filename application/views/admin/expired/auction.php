...
<section class="content-header">
	<h1 class = 'text-info'><i class="fa fa-server"></i> <?php echo $this->lang->line("auction domain list");?></h1>
</section>
	...
	<div class="row" >
		<div class="col-xs-12">
			...
			<form class="form-inline" style="margin-top:20px">
				...
				<button type="button" style="width:195px;" class="btn btn-outline-warning download" id = "download_btn"><i class="fa fa-cloud-download"></i> <?php echo $this->lang->line("download selected");?></button>
				<button type="button" style="width:195px;" class="btn btn-outline-warning download" id = "download_btn_all"><i class="fa fa-cloud-download"></i> <?php echo $this->lang->line("download all");?></button>
