...
<section class="content-header"style="color: <?php echo $THEMECOLORCODE; ?> !important;
    font-weight: 300 !important;">
  <h1><i class="fa fa-bell-o"></i> <?php echo $this->lang->line("send email to users"); ?> </h1>
...
<div id="modal_send_sms_email" class="modal fade" data-backdrop="static" data-keyboard="false">
