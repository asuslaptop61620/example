	...
	<div class="row" style="margin-top: 20px;">
		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="box box-primary">
				...
				<h3 class="box-title" style="color: blue; word-spacing: 4px;"><i class="fa fa-bar-chart"></i> <?php echo $this->lang->line('Day Wise New vs Returning User Report From'); ?> <span id="visitor_type_from_date"></span> to <span id="visitor_type_to_date"></span></h3>
		...
		<div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3">
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title" style="color: blue; word-spacing: 4px;"><i class="fa fa-user"></i> <?php echo $this->lang->line('Total New vs Returning User'); ?></h3>
					<div class="box-tools pull-right">
						<button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
						<button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
					</div>
						...
						<div class="row">
							...
							<div class="col-md-4 col-xs-12" style="padding-top:35px;">
								<ul class="chart-legend clearfix" id="visitor_type_color_codes">
									<li><i class="fa fa-circle-o" style="color: #C8EBE5;"></i> <?php echo $this->lang->line('New User'); ?></li>
			                        <li><i class="fa fa-circle-o" style="color: #F5A196;"></i><?php echo $this->lang->line('Returning User'); ?></li>
								</ul>
							</div><!-- /.col -->
						</div><!-- /.row -->
					</div><!-- /.box-body -->
