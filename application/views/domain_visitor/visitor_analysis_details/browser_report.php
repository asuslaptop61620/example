		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 style="color: blue; word-spacing: 3px;" class="box-title"><i class="fa fa-firefox"></i> <?php echo $this->lang->line('Report From'); ?> <span id="browser_table_from_date"></span> <?php echo $this->lang->line('to'); ?> <span id="browser_table_to_date"></span></h3>
