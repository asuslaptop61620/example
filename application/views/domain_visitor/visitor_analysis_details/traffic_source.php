	...
	<div class="row" style="margin-top: 20px;">
		...
		<div class="col-lg-6 col-md-6 col-xs-12">
			...
			<div class="box box-danger">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-registered"></i> <?php echo $this->lang->line("Top Referrer"); ?> (%)</h3>
		...
		<div class="col-lg-6 col-md-6 col-xs-12">
			...
			<div class="box box-success">
				<div class="box-header with-border">
					<h3 class="box-title"><i class="fa fa-truck"></i> <?php echo $this->lang->line("Total Traffic"); ?></h3>
					<div class="box-tools pull-right">
						<button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
						<button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
					</div>
		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title" style="color: blue; word-spacing: 5px;"><i class="fa fa-bar-chart"></i> <?php echo $this->lang->line("Day Wise Traffic Source Report From"); ?> <span id="traffic_source_from_date"></span> to <span id="traffic_source_to_date"></span></h3>
              <div class="box-tools pull-right">
                <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
              </div>
		...
		<div class="col-xs-12 col-lg-6">
			...
			<div class="box box-info">
				<div class="box-header with-border">
				  <h3 class="box-title" style="color: <?php echo $THEMECOLORCODE; ?>"><i class="fa fa-truck"></i> <?php echo $this->lang->line('Traffic From Search Engines'); ?></h3>
				  <div class="box-tools pull-right">
				    <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
				    <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
				  </div>
		...
		<div class="col-xs-12 col-lg-6">
			...
			<div class="box box-info">
				<div class="box-header with-border">
				  <h3 class="box-title" style="color: <?php echo $THEMECOLORCODE; ?>"><i class="fa fa-truck"></i> <?php echo $this->lang->line('Traffic From Social Networks'); ?></h3>
				  <div class="box-tools pull-right">
				    <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
				    <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
				  </div>
