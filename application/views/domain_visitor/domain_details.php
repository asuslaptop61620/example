...
.tabs-below > .nav-tabs > .active > a, .tabs-below > .nav-tabs > .active > a:hover, .tabs-below > .nav-tabs > .active > a:focus {
    ...
    border-top: 3px solid <?php echo $THEMECOLORCODE; ?> !important;
}
...
<div class="well well_border_left"> <h4 class="text-center"> <i class="fa fa-globe"></i> <?php echo $this->lang->line('Domain Name') ?> - <span class="domain_name"></span></h4> </div>
		...
		<div class="col-xs-12">			
			<div class="tabs-below">
				...
				<ul class="nav nav-tabs" role="tablist">
					...
					<li role="presentation"><a href="#traffic_source" aria-controls="traffic_source" role="tab" data-toggle="tab"><?php echo $this->lang->line('Traffic Source'); ?></a></li>
					<li role="presentation"><a href="#visitor_type" aria-controls="visitor_type" role="tab" data-toggle="tab"><?php echo $this->lang->line('Visitor Type'); ?></a></li>
					<li role="presentation"><a href="#content_overview" aria-controls="content_overview" role="tab" data-toggle="tab"><?php echo $this->lang->line('Content Overview'); ?></a></li>
