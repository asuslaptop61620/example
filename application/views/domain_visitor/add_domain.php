				...
				<div class="box-footer">
					<div class="form-group">
						<div class="col-sm-12 text-center"> 
							<button name="submit" id="submit" type="submit" class="btn btn-primary btn-lg"><i class="fa fa-save"></i> <?php echo $this->lang->line("save");?></button> 
							<button onclick='goBack("domain_details_visitor/domain_list_visitor")' type="button" class="btn btn-default btn-lg"><i class="fa fa-close"></i> <?php echo $this->lang->line("cancel");?></button>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<h3 class="text-center" style="font-size: 14px!important;font-weight: 300"><?php echo $this->lang->line("copy the code below and paste it to your web page");?></h3>
				<div style="font-size: 10px!important;font-weight: 300" class="alert alert-success text-center clearfix">
			...
			$.ajax({
				...
				success:function(response){
					if(response == 0)
						...
						alertify.alert('<?php echo $this->lang->line("Alert") ?>','<?php echo $this->lang->line("You have already added this domain") ?>',function(){});
					else if(response == 2){
