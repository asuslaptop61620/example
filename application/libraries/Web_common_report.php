<?php  
	...
	function __construct()
	{
		...
		$facebook_config=$this->CI->basic->get_data("config",array("where"=>array("user_id"=>$this->user_id)));

		if(isset($facebook_config[0]))
		{			
			$this->app_id=$facebook_config[0]["facebook_app_id"];
			$this->app_secret=$facebook_config[0]["facebook_app_secret"];
	...
	function fb_like_comment_share($url)
	{
		...
		//$url="http://graph.facebook.com/?id=".$url."&fields=engagement&access_token={$access_token}";
