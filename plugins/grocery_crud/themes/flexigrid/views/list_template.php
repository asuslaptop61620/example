...
<div class="flexigrid" style='width: 100%; padding:15px' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div class="mDiv" style="padding-left:0px !important;padding-top:0 !important;color:#333 !important;font-size:18px !important;color:<?php echo $CI->session->userdata('THEMECOLORCODE');?> !important;">
		<div class="ftitle">
			<i class='fa fa-list'></i> <?php echo $subject?>
		</div>		
	</div>
	...
	<div class="sDiv quickSearchBox" id='quickSearchBox' style="display:block;background:#fff;border-bottom:none">
		<div class="sDiv2">
            ...
            <button type="button" class="crud_search btn btn-info" id='crud_search'><i class="fa fa-search"></i> <?php echo $this->l('list_search');?></button>
		</div>
